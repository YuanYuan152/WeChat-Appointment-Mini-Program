...
export const sections: NavigationSection[] = [
  ...
  {
    id: "assessmentEnterprises",
    label: "企业定制",
    desc: "企业专属链接、私有量表与二维码",
    path: "/assessment-enterprises",
    allowedRoles: ["Admin", "Ops", "Assistant"],
  },
  { id: "schedules", label: "排期情况", desc: "未来30天总览与改期", path: "/schedules", allowedRoles: ["Admin", "Ops", "Assistant"] },
