...
export const sections: NavigationSection[] = [
  ...
  { id: "schedules", label: "挂课情况", desc: "咨询师排期总览", path: "/schedules" },
  ...
  { id: "userBoard", label: "用户看板", desc: "用户检索与状态", path: "/user-board" },
...
export const navigationGroups: NavigationGroup[] = [
  { id: "overview", label: "工作台", sectionIds: ["dashboard"] },
  { id: "admin", label: "权限管理", sectionIds: ["roles"] },
  { id: "business", label: "业务处理", sectionIds: ["refunds", "caseRecords", "operationLogs"] },
