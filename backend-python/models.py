...
class AppActivity(Base):
    ...
    LiveDisplayMode = Column(String(20), nullable=True)
    JixinliIconUrl = Column(String(500), nullable=True)
    TongxinliIconUrl = Column(String(500), nullable=True)
    IsActive = Column(Boolean, nullable=False, default=True)
    StartAt = Column(DateTime, nullable=True)
    EndAt = Column(DateTime, nullable=True)
    SortOrder = Column(Integer, nullable=False, default=0)
...
class AppCounselorProfile(Base):
    ...
    Field = Column(UnicodeText, nullable=True)
    ...
    TargetGroup = Column(UnicodeText, nullable=True)
