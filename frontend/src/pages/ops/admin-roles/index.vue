<template>
  ...
  <view class="page-admin-roles">
    ...
    <view class="header">
      ...
      <text class="subtitle">每个账号仅一个角色。管理员 &gt; 咨询主任 &gt; 咨询助理；仅密钥登录管理员可增删改其他管理员，且密钥管理员账号本身不可被删除或更换角色。普通管理员同级不可互操作。内容运营/市场/科研/测试员仅管理员可赋权。测试员可强制彻底删除（含咨询/订单）。主任/助理同级不可互相操作</text>
