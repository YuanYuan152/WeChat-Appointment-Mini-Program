...
export const RELATED_TYPE_LABELS: Record<string, string> = {
  ...
  PATIENT_PROXY_ORDER_CANCELLED: '待支付预约已取消',
  PATIENT_APPOINTMENT_RESCHEDULED: '咨询时间已修改',
  COUNSELOR_APPOINTMENT_RESCHEDULED: '咨询时间已修改',
  COUNSELOR_PROXY_ORDER_PENDING: '代理预约待支付',
  COUNSELOR_PROXY_ORDER_CANCELLED: '代理预约推送已取消',
