...
namespace lxxl
{
    public class WeixinConfig
    {
        ...
        //public static string YingYongID { private set; get; }
        //public static string cert { private set; get; }
        //public static string certPassword { private set; get; }

        public static TokenHelper TokenHelper { private set; get; }
        public static string token { set { } get { return AccessTokenContainer.GetAccessToken(WeixinConfig.AppID); } }
        public static string ticket { set { } get { return CommonApi.GetTicketByAccessToken(WeixinConfig.AppID).ticket; } }
        ...
        public static void Register()
        {
            ...
            //YingYongID = System.Configuration.ConfigurationManager.AppSettings["YingYongID"];
            //cert = System.Configuration.ConfigurationManager.AppSettings["cert"];
            //certPassword = System.Configuration.ConfigurationManager.AppSettings["certPassword"];
