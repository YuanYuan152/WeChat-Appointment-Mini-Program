...
namespace lxxl.Models
{
    ...
    public class T_DoctorSchedule
    {
        ...
        public T_DoctorSchedule(long doctorID, DateTime startTime, DateTime endTime, int maxSign = 0, double Price = 0, string address = "")
        {
            this.gId = Guid.NewGuid().ToString("N");
            this.isDelete = false;
            this.createTime = DateTime.Now;
