 		 ...
 		 init:function(){
				...
				this.zturn.children(".zturn-item").each(function(index,element){	 		
							...
							$(this).css({
								...
								'transform': 'scale(' + scaleMy + ')',
								'-webkit-transform': 'scale(' + scaleMy + ')',
								'-webkit-transform': 'scale(' + scaleMy + ')',
								'-moz-transform': 'scale(' + scaleMy + ')',
								'-ms-transform': 'scale(' + scaleMy + ')',
								'-o-transform': 'scale(' + scaleMy + ')'
							})
